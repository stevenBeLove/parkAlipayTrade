...
public class OrganizationDaoImpl implements OrganizationDao {
    ...
    public Organization createOrganization(final Organization organization) {
        final String sql = "insert into tb_fans_sys_organization(id,name, parent_id, parent_ids, available) values(seq_sysSaleSeq.nextval,?,?,?,?)";
    ...
    public Organization updateOrganization(Organization organization) {
        final String sql = "update tb_fans_sys_organization set name=?, parent_id=?, parent_ids=?, available=? where id=?";
        jdbcTemplate.update(
                sql,
    ...
    public void deleteOrganization(Long organizationId) {
        ...
        final String deleteSelfSql = "delete from tb_fans_sys_organization where id=?";
        jdbcTemplate.update(deleteSelfSql, organizationId);
        final String deleteDescendantsSql = "delete from tb_fans_sys_organization where parent_ids like ?";
    ...
    public Organization findOne(Long organizationId) {
        final String sql = "select id, name, parent_id, parent_ids, available from tb_fans_sys_organization where id=?";
    ...
    public List<Organization> findAll() {
        final String sql = "select id, name, parent_id, parent_ids, available from tb_fans_sys_organization";
    ...
    public List<Organization> findAllWithExclude(Organization excludeOraganization) {
        ...
        final String sql = "select id, name, parent_id, parent_ids, available from tb_fans_sys_organization where id!=? and parent_ids not like ?";
    ...
    public void move(Organization source, Organization target) {
        String moveSourceSql = "update tb_fans_sys_organization set parent_id=?,parent_ids=? where id=?";
        jdbcTemplate.update(moveSourceSql, target.getId(), target.getParentIds(), source.getId());
        String moveSourceDescendantsSql = "update tb_fans_sys_organization set parent_ids=concat(?, substr(parent_ids, length(?))) where parent_ids like ?";
