...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/js/static/jquery-treetable/stylesheets/jquery.treetable.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/js/static/jquery-treetable/stylesheets/jquery.treetable.theme.default.css">
    <style>
        #table th, #table td {
            font-size: 14px;
            padding : 8px;
...
<script src="${pageContext.request.contextPath}/js/static/jquery-treetable/javascripts/src/jquery.treetable.js"></script>
<script>
    $(function() {
