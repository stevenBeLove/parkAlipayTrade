...
import com.qt.sso.service.OAuthService;
import com.qt.sso.service.UserService;

/**
 * <pre>
 * 【类型】: AccessTokenController <br/> 
 * 【时间】：2016年12月30日 下午6:32:34 <br/> 
 * 【作者】：yinghui zhang <br/>
 * </pre>
 */
@RestController
        ...
        try {
            ...
            if (oauthRequest.getParam(OAuth.OAUTH_GRANT_TYPE).equals(GrantType.AUTHORIZATION_CODE.toString())) {
                if (!oAuthService.checkAuthCode(authCode)) {
                    OAuthResponse response = OAuthASResponse.errorResponse(HttpServletResponse.SC_BAD_REQUEST).setError(OAuthError.TokenResponse.INVALID_GRANT).setErrorDescription("错误的授权码")
                            .buildJSONMessage();
                    return new ResponseEntity(response.getBody(), HttpStatus.valueOf(response.getResponseStatus()));
                }
            }
