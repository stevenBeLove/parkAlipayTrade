...
/** 
 * 类名: AlipayUserInfoAuthRequestTest <br/> 
 * 作用：TODO(简单一句话描述)<br/> 
 * 创建者: zhangyinghui. <br/> 
 * 添加时间: 2017年10月22日 下午7:16:13 <br/> 
 * 版本： JDK 1.6 parkAlipay 1.0
 */
public class AlipayUserInfoAuthRequestTest {
    ...
    public static void main(String[] args) {
        ...
        request.setBizContent("{" +
                ...
                "\"is_mobile\":\"true\"" +
                "  }");
        AlipayUserInfoAuthResponse   response;
        try {
