...
//            throw new QTException(RSConsts.RESP_CODE_15_ERR_HOST, "发送数据不为空");
//        }
//
...
//        LogPay.info("发送核心数据=====>>>" + json.toString());
//
//        try {
...
//                    throw new QTException(RSConsts.RESP_CODE_15_ERR_HOST, "请求超时,请稍后重试.");
//                }
...
//            LogPay.error(e.getMessage() + "发送核心异常.", e);
//            throw new QTException(RSConsts.RESP_CODE_15_ERR_HOST, "请求超时,请稍后重试.");
...
//                }
//            } catch (JMSException e) {
//                LogPay.error("参数异常:" + e.getMessage(), e);
//                throw new QTException(RSConsts.RESP_CODE_15_ERR_HOST, "系统异常");
//            }
//        }
//    }
//
