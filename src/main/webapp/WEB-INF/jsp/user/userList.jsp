...
<script src="${ctx}/js/pagejs/user/user.js"></script>
<meta name="viewport"
						...
						<div id="toolbar" class="btn-group">
						   ...
						   <shiro:hasPermission name="user:update">
						    ...
						    <shiro:hasPermission name="user:delete">
							    <button id="btn_del" type="button" class="btn btn-default" onclick="deleteUser();">
							    <span class="glyphicon glyphicon-remove" aria-hidden="true"></span>删除
							   </button>
						   </shiro:hasPermission>
						   
						   <shiro:hasPermission name="user:update">
							   <button id="btn_pwd" type="button" class="btn btn-default" onclick="modifyUserPwd();">
