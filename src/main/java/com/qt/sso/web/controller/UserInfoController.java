...
/**
 * <pre>
 * 【类型】: UserInfoController <br/> 
 * 【时间】：2016年12月30日 下午6:39:47 <br/> 
 * 【作者】：yinghui zhang <br/> 
 * </pre>
 */
...
public class UserInfoController {
    ...
    public HttpEntity userInfo(HttpServletRequest request) throws OAuthSystemException {
        try {
            ...
            OAuthResponse oauthResponse = OAuthRSResponse.errorResponse(HttpServletResponse.SC_UNAUTHORIZED).setRealm(Constants.RESOURCE_SERVER_NAME).setError(e.getError())
