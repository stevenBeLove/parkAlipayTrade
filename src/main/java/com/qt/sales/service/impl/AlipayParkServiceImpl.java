...
import com.qt.sales.service.AlipayParkService;

/** 
 * 类名: AlipayParkServiceImpl <br/> 
 * 作用：支付<br/> 
 * 创建者: zhangyinghui. <br/> 
 * 添加时间: 2017年10月14日 下午4:17:46 <br/> 
 * 版本： JDK 1.6 sharpPark 1.0
 */
public class AlipayParkServiceImpl implements AlipayParkService {

    
    private static Log                  log = LogFactory.getLog(AlipayParkServiceImpl.class);
    ...
    // 测试系统商交易保障调度
    public void monitor_schedule_logic() {
        // 启动交易保障线程
    ...
    /**
     * 【方法名】    : (系统商的调用样例，填写了所有系统商商需要填写的字段). <br/> 
     * 【作者】: yinghui zhang .<br/>
     * 【时间】： 2017年10月28日 下午3:50:01 .<br/>
     * 修改记录.<br/>
     * 修改人:  yinghui zhang 修改描述： .<br/>
     */
    public void monitor_sys() {
    ...
    // 测试当面付2.0支付
    public void trade_pay(AlipayTradeService service) {
    ...
    public void trade_precreate() {
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                // 需要修改为运行机器上的路径
                String filePath = String.format("F://jar/qr-%s.png",
