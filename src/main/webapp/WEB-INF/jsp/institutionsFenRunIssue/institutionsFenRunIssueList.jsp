...
<script src="${ctx}/js/pagejs/institutionsFenRunIssue/institutionsFenRunIssue.js"></script>
...
<body class="bootstrap-admin-with-small-navbar">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div id="toolbar" class="btn-group">
					<shiro:hasPermission name="InstitutionsFenRun:export">
	...
	<script type="text/javascript">
		function ExportInstitutionsFenRunIssue() {
			...
			location.href = ctx
					+ "/institutionsFenRunIssue/institutionsFenRunIssueExportExcel?="
					+ localDate + "&agencyName=" + agencyName + "&limit="
					+ limit + "&offset=" + offset;
		}
	</script>
