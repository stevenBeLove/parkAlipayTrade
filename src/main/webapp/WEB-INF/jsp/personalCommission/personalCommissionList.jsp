...
<title>个人返佣发放查询</title>
<%@ include file="../head.jsp"%>
<script type="text/javascript">
	var ctx = '${ctx}';
</script>
<script src="${ctx}/js/suggest/src/bootstrap-suggest.js"></script>
<script src="${ctx}/js/pagejs/personalCommission/personalCommission.js"></script>
...
<body class="bootstrap-admin-with-small-navbar">
	...
	<div class="page-header">
						...
						<form class="form-horizontal" onsubmit="reloadDate();return false;">
							<fieldset>
								...
								<div class="form-group">
									<label class="col-lg-1 control-label" for="localBeginDate">发放日期</label>
									<div class="col-lg-2">
									...
									<label class="col-lg-1 control-label" for="localDate">分佣月份</label>
									<div class="col-lg-3">
										<input class="form-control datepicker" id="localDate" name="localDate" type="text" />
									</div>
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<shiro:hasPermission name="PersonalCommission:export">	
					<button id="btn_export" type="button" class="btn btn-default" onclick="ExportPersonalCommission();">
	...
	<script type="text/javascript">
		function ExportPersonalCommission() {
			var limit = $("#limit").val();
			var offset = $("#offset").val();
			var fsOrigDate = $("#fsOrigDate").val();
			var localDate = $("#localDate").val();
			var mobile = $("#mobile").val();
			var agencyName = $("#agencyName").val();
			location.href = ctx
					+ "/personalCommission/personalCommissionExportExcel?="
					+ localDate + "&offset=" + offset + "&limit=" + limit
					+ "&fsOrigDate" + fsOrigDate + "&localDate" + localDate
					+ "&mobile" + mobile + "&agencyName" + agencyName;
		}
	</script>
